...
import com.eptonic.photocollage.ui.view.frame.FrameEntity;
...
public class ResultContainer {
    public static final String FRAME_BACKGROUND_IMAGE_KEY = "FRAME_BACKGROUND_IMAGE_KEY";
    public static final String FRAME_IMAGES_KEY = "FRAME_IMAGES_KEY";
    public static final String FRAME_STICKER_IMAGES_KEY = "FRAME_STICKER_IMAGES_KEY";
    public static final String IMAGES_KEY = "IMAGES_KEY";
    public static final String PHOTO_BACKGROUND_IMAGE_KEY = "PHOTO_BACKGROUND_IMAGE_KEY";
