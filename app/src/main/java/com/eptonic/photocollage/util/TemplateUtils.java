...
import com.eptonic.photocollage.ui.view.frame.TwoFrameImage;
...
public class TemplateUtils {
    public static final String FRAME_FOLDER = "template";

    public static TemplateItem collage(String str) {
        TemplateItem templateItem = new TemplateItem();
        templateItem.setPreview(PhotoUtils.ASSET_PREFIX.concat("template").concat("/").concat(str));
