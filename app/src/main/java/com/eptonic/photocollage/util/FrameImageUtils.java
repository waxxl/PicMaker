...
public class FrameImageUtils {
    ...
    private static final String TEMPLATE_FOLDER = "frame";
    ...
    public static ArrayList<TemplateItem> loadFrames() {
...
//        arrayList.add(template_2_4());
    ...
    private static TemplateItem template(String str) {
        ...
        templateItem.setPreview(PhotoUtils.ASSET_PREFIX.concat("frame").concat(File.separator).concat(str).concat(PREVIEW_POSTFIX));
        templateItem.setTemplate(PhotoUtils.ASSET_PREFIX.concat("frame").concat(File.separator).concat(str).concat(TEMPLATE_POSTFIX));
        templateItem.setTitle(str);
        return templateItem;
    }

    private static String createMaskPath(String str, int i) {
        return PhotoUtils.ASSET_PREFIX.concat("frame").concat("/").concat(str).concat("_") + i + ".png";
    }
}