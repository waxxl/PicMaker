...
public class VVVV extends ImageRender {
    ...
    public VVVV() {
        super(TRANSFORM_FILTER_VERTEX_SHADER, ImageRender.NO_FILTER_FRAGMENT_SHADER);
    }
    ...
    public VVVV copyFilter() {
        VVVV transformFilter = new VVVV();
