...
public class HighlightShadowFilter extends ImageFilter {
    ...
    public HighlightShadowFilter(float f, float f2) {
        super(ImageFilter.NO_FILTER_VERTEX_SHADER, HIGHLIGHT_SHADOW_FRAGMENT_SHADER);
        this.mHighlights = f2;
        this.mShadows = f;
    }
