...
public class SketchFilter extends ImageFilterGroup {
    ...
    private final TextureSamplingFilter mTextureSamplingFilter = new TextureSamplingFilter(SKETCH_FRAGMENT_SHADER);

    public SketchFilter() {
        addFilter(new GrayscaleFilter());
        addFilter(this.mTextureSamplingFilter);
    }

    public void setLineSize(float f) {
        this.mTextureSamplingFilter.setLineSize(f);
    }
}
