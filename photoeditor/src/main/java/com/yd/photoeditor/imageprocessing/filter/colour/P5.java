...
public class P5 extends ImageRender {
    ...
    public P5(float f) {
        super(ImageRender.NO_FILTER_VERTEX_SHADER, WWWWWWWWWWWW);
        this.mHue = f;
    }
