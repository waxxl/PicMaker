...
public class Fxxx extends ImageRender {
    ...
    public Fxxx(PointF pointF, float[] fArr, float f, float f2) {
        super(ImageRender.NO_FILTER_VERTEX_SHADER, VIGNETTING_FRAGMENT_SHADER);
