...
public class ImageFilter5 {
    ...
    EGLDisplay mEGLDisplay = egl10.eglGetDisplay(EGL10.EGL_DEFAULT_DISPLAY);
    ...
    public ImageFilter5(int i, int i2) {
        mWidth = i;
        mHeight = i2;
        int[] iArr = {12375, mWidth, 12374, this.mHeight, 12344};
        egl10.eglInitialize(this.mEGLDisplay, new int[2]);
        mEGLConfig = chooseConfig();
        mEGLContext = egl10.eglCreateContext(mEGLDisplay, mEGLConfig, EGL10.EGL_NO_CONTEXT, new int[]{12440, 2, 12344});
        mEGLSurface = egl10.eglCreatePbufferSurface(mEGLDisplay, mEGLConfig, iArr);
    ...
    public void destroy() {
        this.egl10.eglMakeCurrent(this.mEGLDisplay, EGL10.EGL_NO_SURFACE, EGL10.EGL_NO_SURFACE, EGL10.EGL_NO_CONTEXT);
    ...
    private EGLConfig chooseConfig() {
        ...
        int[] iArr3 = iArr;
        this.egl10.eglChooseConfig(this.mEGLDisplay, iArr2, null, 0, iArr3);
        int i = iArr[0];
        this.mEGLConfigs = new EGLConfig[i];
        this.egl10.eglChooseConfig(this.mEGLDisplay, iArr2, this.mEGLConfigs, i, iArr3);
    ...
    private int getConfigAttrib(EGLConfig eGLConfig, int i) {
        int[] iArr = new int[1];
        if (this.egl10.eglGetConfigAttrib(this.mEGLDisplay, eGLConfig, i, iArr)) {
            return iArr[0];
        }
        return 0;
    }
