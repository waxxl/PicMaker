...
import com.yd.photoeditor.imageprocessing.filter.colour.P9;

public class F12345 extends ImageRenderGroup {
    ...
    private final P9 mP9 = new P9(SKETCH_FRAGMENT_SHADER);
